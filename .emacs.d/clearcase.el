...
(defconst clearcase-version-stamp "ClearCase-version: </main/182>")
...
The activity name is generated by ClearCase."
  ...
  (let* ((viewtag (clearcase-fprop-viewtag default-directory))
    ...
    (if (null comment)
      ...
      (let ((temp-file (clearcase-utl-temp-filename))
        ...
        (unwind-protect
            (progn
              (write-region comment nil temp-file nil 'noprint)
              (let ((ret (clearcase-ct-blocking-call "mkact" "-cfile" (clearcase-path-native temp-file)
                                                     "-headline" headline
          ...
          (progn
            (if (not (eq comment 'unused))
                (if comment
                    (progn
                      (write-region comment nil temp-file nil 'noprint)
                      (setq squeezed (append squeezed (list "-cfile" (clearcase-path-native temp-file)))))
...
its ClearCase servers."
  ...
  ;; nyi: Something more lightweight would be nice. Maybe clearlicense ?
  ;;
  (let ((result nil)
...
;;}}}
;;{{{ Functions: to advise some functions
      ...
      (progn
        ...
        (setq clearcase-v4
              (string-match "^ClearCase version 4"
                            clearcase-clearcase-version-installed))
        (setq clearcase-v5
              (string-match "^ClearCase version 5"
                            clearcase-clearcase-version-installed))
        ...
        ;; 4. Ensure that the registry server is available.
        ;;
        (setq clearcase-servers-online (clearcase-servers-online-p))
